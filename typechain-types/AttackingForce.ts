...
export interface AttackingForceInterface extends utils.Interface {
  contractName: "AttackingForce";
  functions: {
...
export interface AttackingForce extends BaseContract {
  contractName: "AttackingForce";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AttackingForceInterface;
