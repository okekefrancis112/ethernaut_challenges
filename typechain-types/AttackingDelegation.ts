...
export interface AttackingDelegationInterface extends utils.Interface {
  contractName: "AttackingDelegation";
  functions: {
...
export interface AttackingDelegation extends BaseContract {
  contractName: "AttackingDelegation";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AttackingDelegationInterface;
